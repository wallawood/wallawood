...
/**
 * Requires the client's {@link io.gemboot.Grant Grant} to contain all of the
 * specified {@link io.gemboot.Grant#scopes() scopes}. Place on a method or class.
 ...
 *
 * @see io.gemboot.Grant#hasScopes(String...)
...
public @interface RequireScopes {
     ...
     * {@link io.gemboot.Grant#scopes() scope set} for the check to pass.
     *
