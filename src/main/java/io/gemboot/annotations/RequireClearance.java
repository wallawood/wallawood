...
/**
 * Requires the client's {@link io.gemboot.Grant Grant} to have a
 * {@link io.gemboot.Grant#level() clearance level} at least equal to the
...
public @interface RequireClearance {
     ...
     * {@link io.gemboot.Grant#level() level()} must be {@code >=} this value.
     *
