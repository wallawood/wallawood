 ...
 * The class must implement {@link io.github.wallawood.RequestInterceptor}.
 *
 * <p>Preprocessors run before any content is served — static or dynamic.
 * They can inspect or enrich the {@link io.github.wallawood.RequestContext} (e.g. add a
 * {@link io.github.wallawood.Grant}), or short-circuit the request by returning a
 * {@link io.github.wallawood.GeminiResponse}.
 *
 ...
 *
 * @see io.github.wallawood.RequestInterceptor
 * @see io.github.wallawood.RequestContext
 */
@Documented
