 ...
 */
public final class WallawoodServerEngine {

    private static final Logger log = LoggerFactory.getLogger(WallawoodServerEngine.class);
     ...
     */
    public WallawoodServerEngine(RouteRegistry routeRegistry, CertificateManager certificateManager,
                              ExceptionResolver exceptionResolver, List<RequestInterceptor> interceptors,
                              WallawoodConfig config) {
