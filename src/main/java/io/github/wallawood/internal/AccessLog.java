...
/**
 * Logs Gemini access events at INFO level on a dedicated logger ({@code io.github.wallawood.access}).
 * This allows operators to route access logs independently from library internals,
 * which log at DEBUG.
 */
public final class AccessLog {

    private static final Logger log = LoggerFactory.getLogger("io.github.wallawood.access");
